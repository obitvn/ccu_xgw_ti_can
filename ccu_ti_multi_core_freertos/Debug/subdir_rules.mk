...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs2031/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"ccsIncludes.opt"  -mcpu=cortex-r5 -mfloat-abi=hard -mfpu=vfpv3-d16 -mlittle-endian -mthumb -O0 -DSOC_AM263PX -DOS_FREERTOS -D_DEBUG_=1 -g -Wall -Wno-gnu-variable-sized-type-not-at-end -Wno-unused-function -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)" -I"D:/VinDynamics/Project/CCU_Robot_Central_Control_Unit/2.firmware/ccu_ti_mutilcore/ccu_ti_multi_core_freertos/Debug/syscfg"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-677062176: ../example.syscfg
	@echo 'SysConfig - building file: "$<"'
	"C:/ti/ccs2031/ccs/utils/sysconfig_1.26.0/sysconfig_cli.bat" -s "C:/ti/mcu_plus_sdk_am263px_11_01_00_19/.metadata/product.json" -p "ZCZ_C" -r "AM263P4" --script "D:/VinDynamics/Project/CCU_Robot_Central_Control_Unit/2.firmware/ccu_ti_mutilcore/ccu_ti_multi_core_realtime/example.syscfg" --context "r5fss1-1" --script "D:/VinDynamics/Project/CCU_Robot_Central_Control_Unit/2.firmware/ccu_ti_mutilcore/ccu_ti_multi_core_freertos/example.syscfg" --context "r5fss0-0" -o "syscfg" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
...
syscfg/%.o: ./syscfg/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler - building file: "$<"'
	"C:/ti/ccs2031/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"ccsIncludes.opt"  -mcpu=cortex-r5 -mfloat-abi=hard -mfpu=vfpv3-d16 -mlittle-endian -mthumb -O0 -DSOC_AM263PX -DOS_FREERTOS -D_DEBUG_=1 -g -Wall -Wno-gnu-variable-sized-type-not-at-end -Wno-unused-function -MMD -MP -MF"syscfg/$(basename $(<F)).d_raw" -MT"$(@)" -I"D:/VinDynamics/Project/CCU_Robot_Central_Control_Unit/2.firmware/ccu_ti_mutilcore/ccu_ti_multi_core_freertos/Debug/syscfg"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
